...
// import { useLocation } from 'react-router-dom'; // extra
...
export default function Form({formTitle, handleModal}:utility) {
   ...
   // const location = useLocation()   // extra
   ...
   const handleSubmit = async (e:React.FormEvent<HTMLFormElement>) => {
      ...
      // const updatedParams = new URLSearchParams(location.search)  // extra
      // updatedParams.set("taskId", "100") // extra
      // navigate(`${location.pathname}?${updatedParams.toString()}`)   // extra

      // console.log(`${location.pathname}?${updatedParams.toString()}`);  // extra
   }
